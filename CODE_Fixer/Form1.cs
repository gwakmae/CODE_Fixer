            ...
            try
            {
                ...
                else
                {
                    ...
                    prompts = new Dictionary<string, string>
                    {
                        ...
                        ["Razor"] = "[기존코드]에 [수정코드]를 적용시켜서 생략없이 전체코드 출력해줘. 너가 코드를 해석해서 추가하거나 그러지 말고 문법적으로 잘 맞게 수정코드를 기존코드에 잘 적용시켜주면 된다. 이것은 Razor이다. 그리고 출력 후 어디를 수정했는지도 알려줘, 코드블록으로 제공해줘",
